...
export default function Toast({
  ...
  switch (type) {
    case 'success':
      return (
        <div
          className="max-w-xs mb-3 bg-green-400 rounded text-white w-full mx-auto px-4 py-2"
          role="alert"
          style={{ zIndex: 200 }}
          {...rest}
        >
    ...
    case 'error':
      return (
        <div
          className="max-w-xs mb-3 bg-danger-400 rounded text-white w-full mx-auto px-4 py-2"
          role="alert"
          style={{ zIndex: 200 }}
          {...rest}
        >
    ...
    case 'warning':
      return (
        <div
          className="max-w-xs mb-3 bg-warning-400 rounded text-white w-full mx-auto px-4 py-2 shadow-md"
          role="alert"
          style={{ zIndex: 200 }}
          {...rest}
        >
    ...
    case 'info':
      return (
        <div
          className="max-w-xs mb-3 bg-blue-500/60 rounded text-white w-full mx-auto px-4 py-2"
          role="alert"
          style={{ zIndex: 200 }}
          {...rest}
        >
